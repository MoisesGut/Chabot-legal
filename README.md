...
Si se desea hacer pruebas de la aplicacion ingresar al siguiente link, la disponibilidad esta sujeta al servidor el cual se encuentra en una maquina virtual: chatbot-legal.ngrok.app 
